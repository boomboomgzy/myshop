...
from myshop.utils.constants import ORDER_STATUS, HtmlTemplate
...
class PaymentStatusView(View):
    ...
    def get(self,req):
        ...
        if success:
            ...
            return render(req, HtmlTemplate.PAY_SUCCESS_HTML, context)
        else:
            res=redirect(reverse("orders:info",args=(1,)))
            return res