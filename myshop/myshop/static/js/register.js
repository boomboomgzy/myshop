    ...
    methods: {
        ...
        check_username() {
            ...
            if (this.error_username === false) {
                // 判断用户名是否重复注册
                let url = '/users/namecounts/' + this.username + '/'
        ...
        check_mobile() {
            ...
            if (this.error_mobile === false) {
                // 校验手机号是否重复注册
                let url = '/users/mobilecounts/' + this.mobile + '/'
                let options = {responseType: 'json'}
                axios.get(url, options)
                    .then(response => {
        ...
        send_sms_code() {
            ...
            // 请求短信验证码
            let url = '/verifications/sms_codes/' + this.mobile + '/?image_code=' + this.image_code + '&uuid=' + this.uuid;
            let options = {responseType: 'json'}
            axios.get(url, options)
                .then(response => {
